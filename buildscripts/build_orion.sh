...
usage() { echo "Usage: $(basename $0) [-c intel-2019.5_openmpi-4.0.2] [-b debug|release] [-m default|geos|gfs] [-n 1..12] [-t ON|OFF] [-x] [-v] [-h]" 1>&2; exit 1; }

# Set input argument defaults.
compiler="intel-2019.5_openmpi-4.0.2"
build="debug"
clean="NO"
model="default"
nthreads=12
